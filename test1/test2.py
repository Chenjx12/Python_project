...
class LoginWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.login_button.clicked = lambda e: self.input_password.setFocus()
        ...
        file_path=os.getcwd()+'\\source\\'+CONFIG_FILE
        if not self.config_empty(file_path):

            self.try_login(self.msg['username'],self.msg['password'])
